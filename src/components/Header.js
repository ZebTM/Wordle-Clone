...
export default function Headers() {
    const onClickHeaderIconHelp = ( event ) => {
        console.log('CLICKED HELP ICON')
        console.log(event)
    }

    const onClickHeaderIconStatistics = ( event ) => {
        console.log('CLICKED STATISTICS ICON')
        console.log(event)
    }

    const onClickHeaderIconSettings = ( event ) => {
            ...
            <header className="header">
                <div className="header-menu-left">
                    <button className='header-icon-left' >
                        <svg aria-hidden="true" className="NavIcon-module_burgerSvg__j9Cig" width="20" height="17" viewBox="0 0 24 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h1 className='header-title'><b>Wordle</b></h1>  
                <menu className='header-menu-right'>
                    <button className='header-icon' onClick={e => onClickHeaderIconHelp(e) }>
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="28" viewBox="4 4 24 24" width="28" className="game-icon" data-testid="icon-help">
                    ...
                    <button  className='header-icon' onClick={e => onClickHeaderIconStatistics(e) }>
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="28" viewBox="4 4 24 24" width="28" className="game-icon" data-testid="icon-statistics">
                    ...
                    <button  className='header-icon' onClick={e => onClickHeaderIconSettings(e) }>
                        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" height="28" viewBox="4 4 24 24" width="28" className="game-icon" data-testid="icon-settings">
